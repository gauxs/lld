...
graph LR
    ...
    %% Styling for paths (explicit text color — readable in light & dark site themes)
    style Start fill:#ffedd5,stroke:#c2410c,stroke-width:2px,color:#7c2d12
    style Step1 fill:#ffffff,stroke:#475569,stroke-width:2px,color:#0f172a
    style Step2 fill:#ffffff,stroke:#475569,stroke-width:2px,color:#0f172a
    style Step3 fill:#ffffff,stroke:#475569,stroke-width:2px,color:#0f172a
    style Step4 fill:#ffffff,stroke:#475569,stroke-width:2px,color:#0f172a
